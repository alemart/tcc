...
(function($) {
  $.fn.openid = function(opt) {
    ...
    var defaults = {
      txt: {
        label: 'Enter your <strong>{provider}</strong> {username}',
        username: 'username',
        title: 'Please select your OpenID provider.',
        sign: 'Go!'
      },
      /*
    ...
    var showInputBox = function() {
      ...
      inputarea.empty().show().append('<span class="oidlabel">' + lbl + '</span><input id="' + INPUTID + '" type="text" ' +
        ' name="username_txt" class="Verisign"/><input type="submit" class="button" value="' + settings.txt.sign + '"/>');
